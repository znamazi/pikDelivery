...
// const DUMMY_DIRECTION = require('../../sample-directions-response');
/**
...
const GoogleApi = {
    ...
    async autoComplete(...params) {
        ...
        return this._request('https://maps.googleapis.com/maps/api/place/autocomplete/json', queryParams);
    },

    async directions(origin, destination, waypoints) {
        // TODO: disable this
        // return DUMMY_DIRECTION;
    ...
    async _request(apiUrl, params){
        let queryParams = { language: 'es', key: this.apiKey, ...this.options, ...params }
        // build url
