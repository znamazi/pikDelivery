        ...
        <KeyboardAvoidingScreen>
            ...
            >
                ...
                <View style={globalStyles.flexRowCenter}>
                    <Text style={[styles.headline, {flexGrow: 1}]}>Available</Text>
                    <Text style={styles.headline}>{availableOrders.count} packages</Text>
                </View>
                {availableOrders.count>0 ? (
                    ...
                    <Text style={styles.noPackage}>No package available</Text>
                )}
