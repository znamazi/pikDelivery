    ...
    return (
        <KeyboardAvoidingScreen>
            <PageContainerDark
                ...
                <Text style={styles.description}>{order?.packages.length} packages to pickup</Text>
                    ...
                    <View key={index}>
                        ...
                        <View style={{height: 24, marginBottom: 24}}>
                            <View style={globalStyles.flexRowCenter}>
                                ...
                                <Text style={styles.itemBarcode}>{order.vehicleType === 'Motorcycle' ? 'Small' : 'Large'} Box</Text>
                            </View>
                        </View>
                    </View>
                ))}
