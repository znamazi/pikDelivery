    ...
    return (
        <KeyboardAvoidingScreen>
            <PageContainerDark
                ...
                Header={<HeaderPage title="Carrier Delivering" />}
            >
                {/*<View styles={styles.container}>*/}
                    ...
                    >
                        ...
                        {!!orderPolyline && <>
                            ...
                            >
                                {order.direction.routes[0].legs[0].duration.text}
                            </MapTooltip>
                        </>}
                    </MapView>
