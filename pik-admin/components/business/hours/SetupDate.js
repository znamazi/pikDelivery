    ...
    return item === 'Not Found' ? (
      <li className="list-unstyled" key={index}>
        <div className="row border-bottom mr-15 mt-2  pb-3">
          <div className="col-lg-9 text-center font-weight-bold p-5">
            {' '}
            {item}
          </div>
        </div>
          ...
          <div className="col-lg-12">
            ...
            <div className="mt-3">
              {!item['totallyClosed'] && (
                <>
                  <span>
                    <strong>{t('information.open')}: </strong> {openAt.label}
                  </span>
                  <span className="ml-5">
    ...
    <div className="col-lg-7">
      ...
      <div className="row mt-4">
        ...
        <div className="col-lg-4 d-flex justify-content-center mt-2">
          <button
            className="btn primary-color-gradient float-right width-100-percent"
            onClick={(e) => {
              setSearchResult([])
              setSearchDate('')
              addCustomDate(e)
