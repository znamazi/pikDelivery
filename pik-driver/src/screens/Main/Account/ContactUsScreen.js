        ...
        Api.Driver.postContactUs(formData)
            .then(({success, message}) => {
                if(success){
                    ...
                    setMessage("Support ticket registered successfully");
                }
                else{
    ...
    return (
        <KeyboardAvoidingScreen>
            ...
            >
                ...
                <Text style={styles.headline}>Upload Image</Text>
                ...
                <View style={globalStyles.inputWrapper}>
                    <CustomAnimatedInput
                        placeholder="Please detail how we can help ?"
                        value={details}
